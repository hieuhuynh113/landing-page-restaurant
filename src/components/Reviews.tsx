  ...
  const reviews = [
    {
      ...
      role: "Food Critic",
      content: "An extraordinary dining experience. The attention to detail in every dish is remarkable. The wine pairing suggestions were perfect, and the service was impeccable.",
      rating: 5,
    ...
    },
    {
      ...
      content: "The wine selection is outstanding, and the sommelier's recommendations were perfect. Each course was thoughtfully paired with exceptional wines.",
      rating: 5,
    ...
    },
    {
      ...
      role: "Regular Guest",
      content: "Every visit feels special. The service is impeccable and the atmosphere is always perfect. The seasonal menu never disappoints.",
      rating: 5,
    ...
    },
    {
      author: "David Wilson",
      role: "Food Blogger",
      content: "A culinary journey that exceeds expectations. The tasting menu was a perfect showcase of seasonal ingredients and creative techniques.",
      rating: 5,
    ...
    },
    {
      ...
      content: "Absolutely blown away by the experience. From the moment we walked in, the service was exceptional. The food was simply outstanding.",
      rating: 5,
        ...
        <div className="mt-16 bg-gray-800 rounded-lg p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">
              We value your feedback. Let us know about your dining experience at Saveur.
            </p>
          </div>
